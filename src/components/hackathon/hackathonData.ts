...
export const HACKATHON_PRESENTATIONS: PresentationRoom[] = [
    {
        roomNumber: 'N2085',
        presentations: [
            { timeSlot: '2:10-2:20', projectName: 'milo' },
            { timeSlot: '2:20-2:30', projectName: 'MitraApp' },
            { timeSlot: '2:30-2:40', projectName: 'PitchReady' },
            { timeSlot: '2:40-2:50', projectName: 'ClimatePro' },
            { timeSlot: '2:50-3:00', projectName: 'Any%' },
            { timeSlot: '3:00-3:10', projectName: 'UniVerse' },
            { timeSlot: '3:10-3:20', projectName: 'FinIt' },
            { timeSlot: '3:20-3:30', projectName: 'UniWallet' },
            { timeSlot: '3:30-3:40', projectName: 'FocusFlow' },
            { timeSlot: '3:40-3:50', projectName: 'GoldenTalks' },
            { timeSlot: '3:50-4:00', projectName: 'HomeRoom' },
            { timeSlot: '4:00-4:10', projectName: 'OpenDoors' },
            { timeSlot: '4:10-4:20', projectName: 'Openspot' },
            { timeSlot: '4:20-4:30', projectName: 'Optima' },
            { timeSlot: '4:30-4:40', projectName: 'Archie' },
            { timeSlot: '4:50-5:00', projectName: 'DriveWise Pro' },
            { timeSlot: '5:00-5:10', projectName: 'Fridge Foodie' },
            { timeSlot: '5:10-5:20', projectName: 'FridgeChef' },
            { timeSlot: '5:20-5:30', projectName: 'Astro' },
            { timeSlot: '5:30-5:40', projectName: 'FillthatCrib' },
            { timeSlot: '5:40-5:50', projectName: 'FinCopilot' },
        ],
    },
    {
        roomNumber: 'LH1011',
